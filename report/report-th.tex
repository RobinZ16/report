...
%% TODO: need to check this carefully (I pulled the number out of my
%% memory when I first wrote this --- in particular, I believe there
%% are only two rational points at infinity, but this needs to be
%% checked.)
