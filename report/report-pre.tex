...
advanced objects apprearing in this paper are defined in here; for
those that are not crucial to the understanding of this paper, we
provide references (in parentheses) when they first appear.
...
concerned about the normalization (most of the time we are in this
paper), we do not need to distinguish between the two types of genus.
