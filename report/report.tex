...
\begin{lemma}
  Let $\{x_1, \ldots, x_{N}\}$ be a $N$-cycle with N even, defined
  over quadratic field K as before. If $x_{\frac{N}{2}+1} \neq
  \overline{x_1}$ and if there are no rational points of exact period
  $N$, then $\{x_1, \ldots, x_{N}\} \cap \{\overline{x_1}, \ldots,
  \overline{x_{N}}\} = \emptyset$.
\end{lemma}
